...
| W7 | 表格：复选多格批量对齐／样式 + 表头、附注行恒「最小一行」 | 未开始（计划见 13.2） |
| W8 | 组件打包（props / emits + lib 构建支持 `.vue` + README） | 未开始（计划见 13.3） |
...
### 13.3 W8 —— 组件打包（最后做，依赖 W6 产出的快捷键表与文件名）
